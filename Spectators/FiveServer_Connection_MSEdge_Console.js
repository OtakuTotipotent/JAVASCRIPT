( () => {
    ...
    "WebSocket"in window && !h && window.addEventListener("load", ( () => {
        ...
        const e = document.querySelector('[data-id="five-server"]')
          , t = new URL(e.src).pathname.split("/").slice(0, -1).join("/")
          , o = `${n = `${"http:" === window.location.protocol ? "ws://" : "wss://"}${new URL(e.src).host}${t}`,
        n.replace(/\/+$/g, "")}/${(e => e.replace(/^\/+/g, ""))("fsws")}`;
        var n;
        const r = e.getAttribute("data-inject-body");
        r && "true" === r.toString() && (g = document.body ? document.body.cloneNode(!0) : void 0);
        let i = null;
        const s = new f(!0);
        s.redraw(),
        ...
        const h = (e, t, o={}) => {
            ...
            if (p === n && "css updated" !== e)
                return;
            p = n;
            let r = document.getElementById("fiveserver-info-wrapper");
            r && r.remove();
            const {time: s=3, animation: a=!0} = o;
            r = document.createElement("div"),
            r.id = "fiveserver-info-wrapper",
            r.classList.add(`fiveserver-info-wrapper_${t}`),
            r.style.zIndex = "100",
            ...
            i = null),
            i = setTimeout(( () => {
                r && r.isConnected && r.remove()
            }
            ), 1e3 * s),
            "error" === t ? (r.style.top = "4px",
            r.style.animation = "",
            l.style.color = "black",
            l.style.backgroundColor = "red") : a ? (r.style.top = "-40px",
            r.style.animation = `fiveserverInfoPopup ${s}s forwards`) : (r.style.top = "4px",
            r.style.animation = ""),
          ...
          , m = (e, ...t) => {
            l && 1 === (null == l ? void 0 : l.readyState) && l.send(JSON.stringify({
                console: {
                    type: e,
                    message: t
                }
          ...
          , y = e => {
            ...
            o.length > 0 && e && h("css updated", "info")
        }
        ;
        let w, b = "";
          ...
          , P = () => {
                ...
                "reload" === t.data)
                    ...
                    ( () => {
                        ...
                        console.log = function(...t) {
                            t[0] === a ? h("connected", "success") : m("log", ...t),
                            e.apply(console, t)
                        }
                        ;
                    ...
                    n.body && n.hot ? (t => {
                        u(void 0, void 0, void 0, (function*() {
                            if ("" === b && (yield(b = "loading",
                            new Promise((t => {
                                const o = new URL(e.src).pathname.split("/").slice(0, -1).join("/")
                                  , n = `//${new URL(e.src).host}${o}/fiveserver/scripts/diffDOM/diffDOM.js`
                                  , r = document.createElement("script");
                                r.type = "text/javascript",
                                r.src = n,
                                r.onload = () => {
                                    setTimeout(( () => {
                                        w = new diffDOM.DiffDOM,
                                        b = "ready",
                                        t()
                                    }
                                    ))
                            ...
                            "ready" === b)
                                try {
                                    const e = g
                                      , o = v.parseFromString(t, "text/html").querySelector("body")
                                    ...
                                    if (w.apply(i, r) && w.apply(document.body, r)) {
                                        g = n,
                                        x && (x = !1,
                                        F("HIDE"));
            ...
            l.onopen = function() {
                ...
                for (let t = 0; t < e.length; t++) {
                    const o = e[t];
                    o.dataset && o.dataset.file && l.send(JSON.stringify({
                        file: o.dataset.file
                    }))
                }
            ...
            l.onclose = function(e) {
                setTimeout((function() {
                    h("lost connection to dev server", "error")
                }
                ), 300),
                0 === c && console.log("Socket is closed. Reconnect will be attempted in 1 second.", e.reason),
                setTimeout((function() {
                    c++,
                    c > 1 && console.log("connecting..."),
                    c <= 25 && P(),
                    d = Math.floor(1.1 * d)
                }
                ), d)
        ...
        const E = () => {
          ...
          , k = () => u(void 0, void 0, void 0, (function*() {
            S++;
            const t = `${new URL(e.src).protocol}//${new URL(e.src).host}${new URL(e.src).pathname.split("/").slice(0, -1).join("/")}/fiveserver/status`;
            try {
                const e = yield fetch(t)
                  , o = yield e.json();
                o && o.status && "online" === o.status ? (P(),
                S = 0) : E()
            } catch (e) {
                E()
            }
